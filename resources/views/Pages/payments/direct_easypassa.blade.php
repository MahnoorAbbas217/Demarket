<ul>
    ...
    <small class="proerty-price pull-left">Pay Rs:{{ $adCost->value ?? 0 }} To Easypassa Account & Please Send your Transection Image or Transection ID to Approve Payment</small>
